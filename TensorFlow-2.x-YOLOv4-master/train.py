...
def main():
    ...
    with open('./trainset.p', 'rb') as file: # trainset = Dataset_train('train') 언피클링
      trainset = pickle.load(file)

    with open('./testset.p', 'rb') as file: # testset = Dataset_test('test') 언피클링
    ...
    if TRAIN_FROM_CHECKPOINT:
        try:
            yolo.load_weights(f"./checkpoints/{TRAIN_MODEL_NAME}_val_loss_Best")
        except ValueError:
